...
- (void)initVuforiaInBackground
{
    ...
    @autoreleasepool {
        ...
        const char *vuforiaLicenseKey = [[dict objectForKey:@"vuforiaLicenseKey"] cStringUsingEncoding:NSASCIIStringEncoding];

        Vuforia::setInitParameters(mVuforiaInitFlags, vuforiaLicenseKey);
